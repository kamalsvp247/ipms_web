...
<template>
    ...
    >
        <header
            class="mb-6 w-full max-w-[20.9375rem] text-sm not-has-[nav]:hidden lg:max-w-4xl"
        >
        ...
        >
            <main
                class="flex w-full max-w-[20.9375rem] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row"
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[1.25rem] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[27.375rem] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                >
                    <svg
                    ...
                    <svg
                        class="relative -mt-[4.9rem] -ml-8 w-[28rem] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:hidden"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <svg
                        class="relative -mt-[4.9rem] -ml-8 hidden w-[28rem] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:block"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
